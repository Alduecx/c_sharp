...
public class HrDirectorConsumer(ILogger<HrDirectorConsumer> _logger, ApplicationDbContext _dbContext, HrDirectorLogic _hrDirector)
...
{ 
    ...
    public async Task Consume(ConsumeContext<GeneratingWishlist> context)
    {
        ...
        await ProcessingIfSufficientData(_dbContext, context.Message.ExperimentId, context.Message.HackathonCount, context);
    }
    ...
    private async Task ProcessingIfSufficientData(ApplicationDbContext dbContext, int experimentId, int hackathonCount, IPublishEndpoint publisher)
    {
    ...
    private async Task<bool> CheckingForSufficientData(ApplicationDbContext dbContext, int experimentId, int hackathonCount)
    {
        ...
        return  teamLeadsWishListsNumber == RequiredNumber && juniorsWishlistsNumber == RequiredNumber && teamsNumber == RequiredNumber; 
    }
